...
if (highPriorityIncomplete.length && highPriorityIncomplete.every(task => !task.completed)) {
    console.log("Todas as tarefas de alta prioridade estão incompletas. Títulos:");
    highPriorityIncomplete.forEach(task => console.log(`- title: "${task.title}"`));
} else {
